...
* The Primordial State (Triple Darkness/Ain Soph Aur): The ultimate, unmanifest potential from which all creation emerges, a plenum of infinite possibility. ¹
* The Original Black Man (God/Atom of Life): The sole, eternal Atom of Life within the Triple Darkness; becomes self-aware and initiates creation by sheer will. 1
    ...
    * (Conceptual Emanations/Manifestations):
        * The Paradise Trinity (Universal Father, Eternal Son, Infinite Spirit): In Urantia cosmology, the ultimate, unmanifest source of all reality.¹
...
* Grand Universe Structure (Urantia Book): A meticulously organized and administered creation. 1
    ...
    * Havona (Central Universe): Surrounds Paradise, a realm of absolute perfection with one billion pristine worlds.¹
    ...
    * Celestial Hierarchy: Administers the Grand Universe. 1
        ...
        * Manu: Divine beings tasked with planning and superintending the evolution of the great "Root Races" on individual planets.¹
* Council of 24 Gods/Scientists (Nation of Islam): A group of highly advanced Black scientists who deliberately engineered Earth and constitute the supreme governing body of the Black Nation and the universe. 1
    * Allah: One of the Twelve Major Scientists, serving as the supreme Judge. ¹
...
* Anunnaki (General): "Princely offspring" who descended from heaven in the time before time and "decreed the fates" of humanity; originated from Nibiru.
    * Anu: The Nibiruan king, father of Enlil and Enki. ¹
...
* Lucifer: A brilliant Lanonandek Son who held the position of System Sovereign of Satania; led a philosophical and spiritual rebellion against divine authority. ¹
...
* Adamu (First Genetically Engineered Human): Created by Enki from hominid DNA and Anunnaki DNA; sterile prototype designed as a "primitive worker" (Lulu); resided in the Garden of Eden (E.DIN, Anunnaki research center).
    * Lilith (Adamu's First Partner): Created equally with Adamu; sovereign feminine spirit; refused subservience; fled Eden; consorted with rebellious entities (e.g., Samael/Lucifer). ¹
    * Lilim / Djinn: Hybrid offspring of Lilith and rebellious entities. 1
    * Eve (Adamu's Second Partner): Fashioned from Adamu's "rib" (genetic material); designed for obedience and controlled procreation. ¹
* Line of Seth: Righteous son of Adamu; passed down the sacred patriarchal line, preserving the Garment of Adam. ¹
    ...
    * Noah: Descendant of Seth; preserved "pure" human and animal life on the Ark during the Great Flood; briefly held the Garment of Adam. ¹
...
* Polarian (First) Root Race: Ethereal, semi-physical beings; reproduction by amoeba-like division.¹
...
* Sixth Root Race (Future): Emerging; characterized by development beyond intellect, with higher psychic faculties (intuition, clairvoyance) becoming normal.¹
* Seventh Root Race (Distant Future): Represents further spiritual evolution, leading to a perfected humanity.¹

V. Hidden Sanctuaries and Knowledge Preservation (Organizational/Lineage of Knowledge)

* Agartha: An enduring subterranean civilization, a physical network of cities and tunnels within the Earth's crust, serving as the primary repository of pre-cataclysmic knowledge. ¹
    * Shamballa: The capital city of Agartha, functioning as the planet's true spiritual and administrative center, ruled by the "King of the World" (Rigden Jyepo).¹
...
* Vatican Secret Archives: Contains the most important texts from the Library of Alexandria, secretly transported to Rome, serving as a custodian of suppressed historical and scientific knowledge. ¹
* Great White Brotherhood: A legendary order of Ascended Masters working behind the scenes to guide humanity's political and spiritual evolution.
    * Count of St. Germain: A primary emissary of the Great White Brotherhood, appearing as an alchemist and diplomat.¹
...
* Nation of Islam (NOI): An African-American religious and political organization with a unique cosmology, positing a council of 24 Black Scientists as true guides of history. 1
    ...
    * Bilal ibn Rabah: The first Muezzin of Islam, seen as an exemplar of the "Original Man" re-establishing his divine connection. ¹
`
  },
  "timeline": {
...
* The Primordial State (Triple Darkness/Ain Soph Aur): The ultimate, unmanifest potential from which all creation emerges, a synthesis of darkness and light. This state is a plenum, a primordial womb of infinite possibility, containing all possibilities in perfect, undifferentiated unity.¹
...
* First Manifestation: The pivotal moment when the "Atom of Life" becomes self-aware, initiating the thought of creation and bringing forth the very first atom of the physical universe by sheer will. ¹
...
* The Polarian (First) Root Race Era: (Earth still cooling) - Characterized by ethereal, semi-physical beings inhabiting the Mount Meru region (North Pole). Their reproduction occurred through amoeba-like division. This era concludes with the Earth's cooling and solidification. ¹
* The Hyperborean (Second) Root Race Era: (Millions of years ago from 2025) This race consisted of more defined, golden-yellow, still etheric beings primarily located in Northern Asia and Greenland. They reproduced by budding. This era ends with significant geological shifts and further cooling of the planet. ¹
...
* Approx. 16.5 Million Years Ago from 2025: "Sin of the Mindless": Some early Lemurians interbreed with huge she-animals, creating degraded lineages (identified as the ancestors of apes) and contributing to the race's eventual downfall. ¹
...
* Approx. 4-5 Million Years Ago from 2025: Emergence of the Atlanteans: The Fourth Root Race arises from the most advanced stock of the Lemurian race, establishing a vast continent that occupied the bulk of the Atlantic Ocean basin. ¹
...
* Tens of thousands of years (duration): Anunnaki Gold-Mining Operation: The arduous gold-mining operations on Earth are conducted by the Igigi, a lower-ranking class of Anunnaki. This prolonged toil eventually leads to the Igigi Revolt.¹
...
* Tower of Babel & Confounding of Language: Nimrod attempts to build a "spaceport" to challenge Anunnaki dominance. The Anunnaki respond with a technological (sonic/frequency-based) attack, fracturing universal language and scattering humanity, preventing collective unity. This dispersal represents a major migration wave and the linguistic fragmentation of humanity. ¹
...
* с. 1600 BCE (Approx. 3,625 years ago from 2025): Thera (Santorini) Volcanic Eruption: A natural disaster with widespread regional societal impact. ¹
...
* 1862 CE (163 years ago from 2025): Sirius B Confirmed: Modern astronomy confirms Sirius is a binary system with the observation of its companion star, Sirius B, a fact known to the Dogon for centuries.¹
* 1908 CE (117 years ago from 2025): Tunguska Event: Identified as a test of the first human-built Mothership (according to Nation of Islam teachings).¹
...
`
  ...
  "migrationsTable": {
    ...
    data: [
      ["Lemurian Destruction (Prolonged Volcanic Activity & Submergence)", "Approx. 16.5 Million Years Ago from 2025", "Survivors migrate to Atlantis, Asia, Africa.", "Dispersal of the Third Root Race; seeds for subsequent Root Races; preservation of some ancient knowledge in new lands.", "Lemurian (Third Root Race) inhabitants¹"],
      ...
      ["Tower of Babel (Technological Attack)", "Post-Flood Era", "Linguistic fracturing & scattering of unified humanity; forced dispersal across the Earth.", "Disunity among mankind; prevention of large-scale collective action; new linguistic and cultural divisions; ensures humanity remains fragmented and easier to control.", "Unified post-diluvian humanity¹ Atlantean/Lemur"],
      ["Late Bronze Age Collapse (Arrival of \"Sea Peoples\")", "с. 1200 BCE (Approx. 3,225 years ago from 2025)", "\"Sea Peoples\" (Atlantean/Lemurian survivors) migrate across the Mediterranean.", "Collapse of major empires (Hittite, Mycenaean Greece); widespread societal disruption; re-shaping of regional power structures.", "ian survivors¹"],
...
const simplifiedConcepts = {
  ...
  thegreatfloodsimplified: {
    ...
    explanation: "The widespread myth of a global flood is presented as a deliberate event, engineered by the Anunnaki leader Enlil. Its purpose was 'planetary eugenics'—to cleanse Earth of the violent hybrid offspring of celestial beings and humans (the Nephilim) and other 'corrupted' human lineages, allowing for a 'reset' and the preservation of 'pure' human lines."
  },
  lostknowledge: {
    title: "The Deliberate Hiding of Knowledge",
    explanation: "Throughout history, there has been a 'Great Theft of Knowledge'—a systematic effort to suppress humanity's true past and inherent potential. This involved altering sacred texts, demonizing the divine feminine (like Lilith), destroying libraries (like Alexandria), and promoting abstract philosophies that disconnected humans from tangible reality. The goal was to control humanity by keeping it ignorant of its true origins and power."
  },
  truenatureofgod: {
